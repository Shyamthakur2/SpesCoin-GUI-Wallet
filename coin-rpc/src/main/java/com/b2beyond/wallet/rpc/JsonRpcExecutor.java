...
System.out.println("IO - JSon Rcp Executor failed : " + e.getMessage() + " on : " + baseUrl + " with method " + method);
...
System.out.println("General - JSon Rcp Executor failed : " + e.getMessage() + " on : " + baseUrl + " with method " + method);
