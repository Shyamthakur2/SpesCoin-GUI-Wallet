...
public final class spesUtil {

    private static Logger LOGGER = Logger.getLogger(spesUtil.class);
    ...
    public static Color panelColor = new Color(105, 253, 151);
    public static Color splashTextColor = new Color(28, 253, 143);
    public static Color mainColor = new Color(59, 255, 115);
    public static Color selectedColor = new Color(21, 239, 141);
    public static Color textColor = new Color(51, 2, 7);
...
//                            getBinariesRoot() + poolMinerExecutable);
    ...
    public static int getPid(Process process, String operatingSystem, boolean spawned) {
        if (spesUtil.WINDOWS.equalsIgnoreCase(operatingSystem)) {
            ...
            if (process.getClass().getName().equals("java.lang.UNIXProcess")) {
                try {
                    ...
                    f.setAccessible(true);
                    if (spesUtil.MAC.equalsIgnoreCase(operatingSystem)) {
                        if (spawned) {
                ...
                if (StringUtils.isNotBlank(timestamp)) {
                    if (splitContainer.length == 1) {
                        Files.copy(
                                ...
                                new FileOutputStream(fileLocation + spesUtil.SEPARATOR + containerName + "." + timestamp + ".bckp"));
                    } else {
                        Files.copy(
                                Paths.get(container),
                                new FileOutputStream(fileLocation + spesUtil.SEPARATOR + containerName + "." + timestamp + ".bckp"));
                    ...
                    if (splitContainer.length == 1) {
                        Files.copy(
                                Paths.get(userHome + container),
                                new FileOutputStream(fileLocation + spesUtil.SEPARATOR + containerName));
                    } else {
                        Files.copy(
                                Paths.get(container),
                                new FileOutputStream(fileLocation + spesUtil.SEPARATOR + containerName));
    ...
    public static String getDeleteBlockChainHomeCommand() {
        ...
        String windows = "AppData" + spesUtil.SEPARATOR + "Roaming" + spesUtil.SEPARATOR + "spescoin";
        String unix = ".spescoin";
