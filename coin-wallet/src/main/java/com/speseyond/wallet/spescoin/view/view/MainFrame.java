...
import com.speseyond.wallet.rpc.model.*;
...
public class MainFrame extends JFrame implements Observer {
    ...
    public MainFrame(PropertiesConfiguration applicationProperties, ActionController actionController) {
        ...
        this.setTitle("SpesCoin GUI");
        this.setBackground(spesUtil.mainColor);
        ...
        splitPane.setForeground(spesUtil.mainColor);
            ...
            button.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                    ...
                    for (JButton buttonLoop : menus) {
                        buttonLoop.setBackground(spesUtil.mainColor);
                    }

                    for (JButton buttonLoop : menus) {
                        if (buttonLoop.getText().equals(button.getText())) {
                            buttonLoop.setBackground(spesUtil.selectedColor);
                        }
                    }
                }
            });
    ...
    public void update(Observable rpcPoller, Object data) {
        ...
        if (data instanceof com.speseyond.wallet.rpc.model.Error) {
    ...
    private JButton createMenuButton(JPanel menu, int yPosition, String buttonCaption, ImageIcon icon, boolean enabled) {
        ...
        buttonShowOverviewPanel.setBackground(spesUtil.mainColor);
        ...
        buttonShowOverview.setBackground(spesUtil.mainColor);
