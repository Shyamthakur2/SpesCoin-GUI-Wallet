...
import com.speseyond.wallet.spescoin.view.view.panel.JpanelWithBackground;
...
public class SplashWindow extends JWindow {
    ...
    void jbInit() throws Exception {
        ...
        // Adding to JPanel
        JLabel authorLabel = new JLabel("Authors : Asm and SpesCoin");
        JLabel logoDesignerLabel = new JLabel("https://myspes.org");
        JLabel versionLabel = new JLabel("Wallet version " + version);
        JLabel copyrightLabel = new JLabel("@SpesCoin 2018");
        ...
        // Setting colors
        authorLabel.setForeground(spesUtil.selectedColor);
        logoDesignerLabel.setForeground(spesUtil.selectedColor);
        versionLabel.setForeground(spesUtil.selectedColor);
        copyrightLabel.setForeground(spesUtil.selectedColor);
