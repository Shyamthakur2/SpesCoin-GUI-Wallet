...
import * as user from './services/com.speseyond.api.user';
import * as spescoin from './services/com.speseyond.api.spescoin';
...
@NgModule({
    ...
    providers: [ // expose our Services and Providers into Angular's dependency injection
        ...
        {provide: spescoin.BASE_PATH, useValue: baseUrl + "/spescoin/api"}
    ]
})
