...
//import { spesCurrencyFormatterDirective } from "../../../../theme/directives/formatter/spesCurrencyFormatter.directive";
...
export class CreatePayment implements OnInit {
    ...
    public selectedAddress: spescoinModels.AddressBalance = {};
    ...
    public payment: spescoinModels.PaymentInput = {
        fee: 0,
        transfers: {}
    };
    ...
    public createPayment() {
        ...
        let address: spescoinModels.Address = {};
