...
export class WalletService {
    ...
    public addresses: Array<spescoinModels.UserAddress> = [];
    public coins: Array<spescoinModels.WalletCoin> = [];
    public primaryCoin: spescoinModels.WalletCoin = {name: ""} ;
    public selectedCoin: spescoinModels.WalletCoin = {name: ""} ;

    public faucetAddress: spescoinModels.UserAddress = {};
    public faucetAddressPayments: Array<spescoinModels.FaucetAddressPayment> = [];
    ...
    @Output()
    public addressFetchedEmitter = new EventEmitter<spescoinModels.UserAddress>();

    @Output()
    public faucetAddressUpdateEmitter = new EventEmitter<spescoinModels.UserAddress>();

    @Output()
    public faucetAddressPaymentsFetchedEmitter = new EventEmitter<Array<spescoinModels.FaucetAddressPayment>>();

    @Output()
    public transactionsFetchedEmitter = new EventEmitter<spescoinModels.WalletCoin>();

    @Output()
    public paymentsFetchedEmitter = new EventEmitter<spescoinModels.WalletCoin>();
    ...
    public getNumberOfAddresses (coinType : spescoinModels.WalletCoin) {
    ...
    public getAddressesForCoin(coinType : spescoinModels.WalletCoin) {
    ...
    public getAddressesObservable (): Observable<Array<spescoinModels.Address>> {
        return this.walletApi.getAddresses();
    }

    public getBalanceObservable (userAddress: spescoinModels.UserAddress): Observable<spescoinModels.AddressBalance> {
        return this.walletApi.getBalance(userAddress);
    }

    public getLastBlockObservable (coinType: string): Observable<spescoinModels.BlockWrapper> {
    ...
    private getCoinForName(coinName): spescoinModels.WalletCoin {
        for (let i = 0; i < this.coins.length; i++) {
